...
int main() {
    ...
    printf("=== Introduza os dados da primeira pessoa ===\n");
    printf("Nome: ");
    ...
    printf("\n=== Introduza os dados da segunda pessoa ===\n");
    printf("Nome: ");
    ...
    printf("Morada: %s", pessoa1.morada);
    printf("Telefone: %s", pessoa1.telefone);
    printf("Idade: %d\n", pessoa1.idade);

    printf("\n=== Pessoa 2 ===\n");
    printf("Nome: %s", pessoa2.nome);
    printf("Morada: %s", pessoa2.morada);
    printf("Telefone: %s", pessoa2.telefone);
    printf("Idade: %d\n", pessoa2.idade);
