<%-- 
    ...
    Created on : 26/01/2026, 16:10:05
    Author     : michael
--%>
...
<html>
    ...
    <body>
        ...
        if (request.getMethod().equals("POST")){
            ...
            // caso vá inserir
                String cat = request.getParameter("subcategoria");
                try{
                    //criar a instância da casse a ser usada
                    Class.forName("com.mysql.jdbc.Driver");
                    //criação da conexão à base de dados
                    Connection conn = DriverManager.getConnection(""
                    + "jdbc:mysql://localhost:3306/bd_02", "root", "");
                    String sql = "INSERT INTO tSubCategoria (subcategoria) VALUES (?)";
                    PreparedStatement pstm = conn.prepareStatement(sql);
                    //substituo os valores pelos pontos de interrogação
        ...
        <section>
            <h2>Inserção de Subcategorias</h2>
            <article>
                <table style="border: 1px solid black;">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="gerirSubCat.jsp" method="post">
        ...
        <h2>Inserção de Subcategorias</h2>
            <article>
                <form action="gerirSubCat.jsp" method="post">
                    Subcategoria:<input type="text" size="20" maxlength="20" required
                                name="subcategoria" placeholder="Romanco, técnico, ..."><br>   
