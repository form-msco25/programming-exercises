<%-- 
    Document   : pesqCat
    Created on : 30/01/2026, 16:38:17
    Author     : michael
--%>
    ...
    <body>
        ...
        if (request.getMethod().equals("POST")){
            ...
            // caso vá pesquisar
                ...
                %>
                <h3>Pesquisa de <b><i><u> <%=texto%> </u></i></b> nas categorias</h3>
                ...
                try{
                    ...
                    int num = 0;
                    ResultSet rs=stm.executeQuery("SELECT * from tCategoria WHERE"
                    ...
                    %>
                        <tr>
                            ...
                            <td>
                                <form action="pesqCat.jsp" method="post">
