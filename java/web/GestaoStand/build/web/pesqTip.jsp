<%-- 
    Document   : pesqTip
    Created on : 06/02/2026, 16:41:13
    Author     : michael
--%>
    ...
    <body>
        ...
        if (request.getMethod().equals("POST")){
            ...
            // caso vá pesquisar
                ...
                %>
                <h3>Pesquisa de <b><i><u> <%=texto%> </u></i></b> nos tipos</h3>
                ...
                try{
                    ...
                    int num = 0;
                    ResultSet rs=stm.executeQuery("SELECT * from t_Tipo WHERE "
                    + "marca LIKE '%"+texto+"%'");
                    while(rs.next()){
                    %>
                        <tr>
                            ...
                            <td>
                                <form action="pesqTip.jsp" method="post">
        ...
        <!-- código inserir.html -->
        <section>
        <h2>Pesquisa de Tipo</h2>
            <article>
                <form action="pesqTip.jsp" method="post">
                    <input type="hidden" name="acao" value="pesquisar">
                    Valor a pesquisar:<input type="text" size="20" maxlength="20" required
                                name="marca" placeholder="Gasolina, Gasóleo, Híbrido ..."><br>   
