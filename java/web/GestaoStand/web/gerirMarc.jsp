<%-- 
    Document   : gerirMarc
    Created on : 06/02/2026, 16:20:33
    Author     : michael
--%>
...
<html>
    ...
    <body>
        ...
        if (request.getMethod().equals("POST")){
            ...
            // caso vá inserir
                ...
                try{
                    ...
                    Connection conn = DriverManager.getConnection(""
                    + "jdbc:mysql://localhost:3306/bd_stand", "root", "");
                    String sql = "INSERT INTO t_Marca (marca) VALUES (?)";
                    PreparedStatement pstm = conn.prepareStatement(sql);
                    //substituo os valores pelos pontos de interrogação
                    pstm.setString(1, marc);             
                    //tenta executar a inserção
            ...
            <article>
                <table style="border: 1px solid black;">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="gerirMarc.jsp" method="post">
        ...
        <!-- código inserir.html -->
        <section>
        <h2>Inserção de Marcas</h2>
            <article>
                <form action="inserirMarc.jsp" method="post">
                    Marca:<input type="text" size="20" maxlength="20" required
