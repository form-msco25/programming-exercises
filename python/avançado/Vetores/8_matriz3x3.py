...
if __name__=="__main__":
    ...
    for i in range(3):
        linha = []
        for j in range(3):
            valor = int(input(f"Matriz A[{i}][{j}]: "))
            linha.append(valor)
    ...
    for i in range(3):
        linha = []
        for j in range(3):
            valor = int(input(f"Matriz B[{i}][{j}]: "))
            linha.append(valor)
    ...
    """print("A soma de matrizes é:")
    for linha in soma:
        print(linha)"""
    media = [[soma[i][j] // 2 for j in range(3)] for i in range(3)] # / para dividir // para que a divisão fique inteira
    print("A media das matrizes é:")
    for linha in media:
        print(linha)
    print("===================================")
    pos_A = 0
