...
namespace MVC_Viatura.Controllers
{
    public class ViaturasController : Controller
    {
        private readonly MVC_ViaturaContext _context;

        public ViaturasController(MVC_ViaturaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Marca,Modelo,Cor,Cilindrada,Ano,Mes,Tipo,Preco,FormaPagamento")] Viatura viatura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Marca,Modelo,Cor,Cilindrada,Ano,Mes,Tipo,Preco,FormaPagamento")] Viatura viatura)
        {
            if (id != viatura.Id)
            {
                return NotFound();
