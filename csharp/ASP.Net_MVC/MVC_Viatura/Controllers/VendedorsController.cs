...
namespace MVC_Viatura.Controllers
{
    public class VendedorsController : Controller
    {
        ...
        public VendedorsController(MVC_ViaturaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Morada,Email,Telefone,Nib,Contribuinte")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Morada,Email,Telefone,Nib,Contribuinte")] Vendedor vendedor)
        {
            if (id != vendedor.Id)
            {
                return NotFound();
