...
<body>
        ...
        <h1>Alteração de Manuais</h1><br/><br/>
        <?php
        include 'liga_bd.php';
            // Executo o SQL no meu servidor
            $sql = "UPDATE manuais SET titulo='$_POST[titulo]', numpag='$_POST[numpag]', textdescr='$_POST[textdescr]', pesokb='$_POST[pesokb]', autor='$_POST[autor]' WHERE id=$_POST[id]";
            //echo $sql;
            //se conseguir inserir os dados mostra a mensagem de "Manual inserido com sucesso"
            if(mysqli_query($ligacao, $sql)){
                echo "<h2> Manual alterado com sucesso!</h2>";
            }
