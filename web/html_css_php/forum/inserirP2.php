...
<body>
        ...
        <?php
            ...
            $sql = "INSERT INTO t_post (tema, titulo, texto, foto, id_user) VALUES ('$_POST[tema]', '$_POST[titulo]', '$_POST[texto]', '$_POST[foto]', $_POST[id_user])";
            //echo $sql;
            //se conseguir inserir os dados mostra a mensagem de "Registo efetuado com sucesso!"
            if(mysqli_query($ligacao, $sql)){
                echo "<h2> Notícia colocada com sucesso!</h2>";
            }
