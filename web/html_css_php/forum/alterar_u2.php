...
<head>
    ...
    <title>Gestão Utilizadores - MO</title>
...
<body>
        ...
        <h1>Alteração de Utilizadores</h1><br/><br/>
        <?php
            include 'liga_bd.php';
            // Executo o SQL no meu servidor
            $sql = "UPDATE t_user SET nick='$_POST[nick]', nome='$_POST[nome]', email='$_POST[email]', data_nasc='$_POST[data_nasc]', pass='$_POST[pass]', foto='$_POST[foto]' WHERE id=$_POST[id]";
            echo $sql;
