...
<body>
        ...
        <h1>Inserçao de Clientes</h1><br/><br/>
        <?php
            ...
            $sql = "INSERT INTO t_cliente (nome, morada, zona, nif, vol_fatur) VALUES ('$_POST[nome]', '$_POST[morada]', '$_POST[zona]', '$_POST[nif]', $_POST[vol_fatur])";
            //echo $sql;
